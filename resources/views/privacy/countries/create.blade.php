...
@section('title', 'Crear País - SGPD COAC')
@section('active_key', 'countries')
@section('h1', 'Crear Nuevo País')
@section('subtitle', 'Agregar un nuevo país al catálogo')
...
@endif
    <div class="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
        <form method="POST" action="{{ route('privacy.countries.store') }}" class="space-y-6">
            @csrf
