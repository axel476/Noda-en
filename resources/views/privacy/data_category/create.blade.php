...
@section('title', 'Crear Categoría de Datos - SGPD COAC')
@section('active_key', 'data_category')
@section('h1', 'Crear Nueva Categoría de Datos')
@section('subtitle', 'Agregar una nueva categoría al catálogo')

@section('content')
<div class="max-w-2xl mx-auto">
    <div class="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
        <form method="POST" action="{{ route('privacy.data_category.store') }}" class="space-y-6">
            @csrf
            ...
            <div>
                ...
                <div class="space-y-2">
                    <label class="inline-flex items-center">
                        <input type="radio" name="is_sensitive" value="0" {{ old('is_sensitive', '0') == '0' ? 'checked' : '' }}
                               class="text-blue-600 focus:ring-blue-500">
                        <span class="ml-2">No</span>
                    </label>
                    <label class="inline-flex items-center ml-6">
                        <input type="radio" name="is_sensitive" value="1" {{ old('is_sensitive') == '1' ? 'checked' : '' }}
                               class="text-blue-600 focus:ring-blue-500">
