    ...
    <div class="w-full max-w-xl">
        ...
        <div class="bg-white border border-gray-200 rounded-xl shadow-sm">
            ...
            <div class="p-6">
                <form id="frm_result"
                      method="POST"
                      action="{{ route('training.results.store', $assignment) }}"
                      class="space-y-5">
                    @csrf

                    {{-- Info --}}
                    <div class="bg-gray-50 p-4 rounded-lg text-sm">
                        <p><strong>Usuario:</strong> {{ $assignment->user->full_name }}</p>
                    ...
                    <div class="flex justify-end gap-3 pt-4 border-t border-gray-100">
                        ...
                        <button type="submit"
                                class="px-5 py-2 rounded-lg bg-green-600
                                       text-white text-sm font-medium hover:bg-green-700">
                            Guardar
                        </button>
                    </div>
