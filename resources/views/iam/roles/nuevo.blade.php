...
@section('title', 'Nuevo Rol - SGPD COAC')
    ...
    <div class="bg-white rounded-lg border border-gray-200 mb-6 p-5">
        <div class="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
            <div>
                ...
                <p class="text-gray-600 mt-1">Registrar un nuevo rol en el sistema SGPD COAC</p>
            </div>
            ...
            <div class="p-6 space-y-6">
                ...
                <div>
                    ...
                    <p class="mt-2 text-sm text-gray-500">
                        Nombre único para identificar el rol en el sistema.
                    </p>
                </div>
                ...
                <div>
                    ...
                    <textarea 
                        ...
                        rows="5"
                        class="w-full px-4 py-2.5 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-colors"
                        placeholder="Describe las funciones y responsabilidades de este rol...">{{ old('description') }}</textarea>
                    @error('description')
                        <p class="mt-2 text-sm text-red-600">{{ $message }}</p>
                    @enderror
                    <p class="mt-2 text-sm text-gray-500">
                        Información adicional sobre el propósito y alcance del rol.
                    </p>
                </div>
                            ...
                            @forelse($permissions as $perm)
                                <div class="flex items-start p-2 hover:bg-white rounded transition-colors">
                                    <input type="checkbox" 
                                        ...
                                        @if(is_array(old('permissions')) && in_array($perm->perm_id, old('permissions'))) checked @endif>
